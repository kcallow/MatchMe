...
$jscode.="TEXT_MONTH_JAN='".jsreplace("Enero")."';\r\n";
$jscode.="TEXT_MONTH_FEB='".jsreplace("Febrero")."';\r\n";
$jscode.="TEXT_MONTH_MAR='".jsreplace("Marzo")."';\r\n";
$jscode.="TEXT_MONTH_APR='".jsreplace("Abril")."';\r\n";
$jscode.="TEXT_MONTH_MAY='".jsreplace("Mayo")."';\r\n";
$jscode.="TEXT_MONTH_JUN='".jsreplace("Junio")."';\r\n";
$jscode.="TEXT_MONTH_JUL='".jsreplace("Julio")."';\r\n";
$jscode.="TEXT_MONTH_AUG='".jsreplace("Agosto")."';\r\n";
$jscode.="TEXT_MONTH_SEP='".jsreplace("Septiembre")."';\r\n";
