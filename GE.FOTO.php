 ...
 */
    ...
    class GE_FOTOPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('GE_FOTOssearch', $this->dataset,
                array('FOTO_ID', 'LA1', 'TITULO', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('FOTO ID'), $this->RenderText('USERNAME'), $this->RenderText('TITULO'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
    ...
    try
    {
        ...
        $Page->SetShortCaption('FOTO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('FOTO');
