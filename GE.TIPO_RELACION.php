 ...
 */
    ...
    class GE_TIPO_RELACIONPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_TIPO_RELACIONssearch', $this->dataset,
                array('TIPO_RELACION_ID', 'NOMBRE', 'FECHA_CREACION', 'FECHA_MODIFICACION', 'USUARIO_CREACION', 'USUARIO_MODIFICACION'),
                array($this->RenderText('TIPO RELACION ID'), $this->RenderText('NOMBRE'), $this->RenderText('FECHA CREACION'), $this->RenderText('FECHA MODIFICACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('USUARIO MODIFICACION')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_TIPO_RELACIONasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('TIPO_RELACION_ID', $this->RenderText('TIPO RELACION ID')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('FECHA_CREACION', $this->RenderText('FECHA CREACION'), 'Y-m-d'));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('FECHA_MODIFICACION', $this->RenderText('FECHA MODIFICACION'), 'Y-m-d'));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('USUARIO_MODIFICACION', $this->RenderText('USUARIO MODIFICACION')));
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('tipo_relacion_id_edit');
            $editColumn = new CustomEditColumn('TIPO RELACION ID', 'TIPO_RELACION_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_TIPO_RELACION_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_TIPO_RELACIONGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_TIPO_RELACIONPage("GE.TIPO_RELACION.php", "GE_TIPO_RELACION", GetCurrentUserGrantForDataSource("GE.TIPO_RELACION"), 'UTF-8');
        $Page->SetShortCaption('TIPO RELACION');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('TIPO RELACION');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.TIPO_RELACION"));
