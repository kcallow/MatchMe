 ...
 */
    ...
    class GE_PERSONAPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('GENERO_ID', 'GE.GENERO', new IntegerField('GENERO_ID'), new StringField('NOMBRE', 'LA1', 'LT1'), 'LT1');
            $this->dataset->AddLookupField('CIUDAD_ID', 'GE.CIUDAD', new IntegerField('CIUDAD_ID'), new StringField('NOMBRE', 'LA2', 'LT2'), 'LT2');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_PERSONAssearch', $this->dataset,
                array('USERNAME', 'ES_ADMIN', 'NACIMIENTO', 'PRIMER_APELLIDO', 'SEGUNDO_APELLIDO', 'NOMBRE', 'LA1', 'LA2', 'SLOGAN', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD', 'EMAIL', 'CLAVE'),
                array($this->RenderText('USERNAME'), $this->RenderText('ES ADMIN'), $this->RenderText('NACIMIENTO'), $this->RenderText('PRIMER APELLIDO'), $this->RenderText('SEGUNDO APELLIDO'), $this->RenderText('NOMBRE'), $this->RenderText('GENERO ID'), $this->RenderText('CIUDAD ID'), $this->RenderText('SLOGAN'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD'), $this->RenderText('EMAIL'), $this->RenderText('CLAVE')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_PERSONAasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ES_ADMIN', $this->RenderText('ES ADMIN')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('NACIMIENTO', $this->RenderText('NACIMIENTO'), 'Y-m-d'));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('GENERO_ID', $this->RenderText('GENERO ID'), $lookupDataset, 'GENERO_ID', 'NOMBRE', false, 8));
            ...
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NOMBRE', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('CIUDAD_ID', $this->RenderText('CIUDAD ID'), $lookupDataset, 'CIUDAD_ID', 'NOMBRE', false, 8));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('SLOGAN', $this->RenderText('SLOGAN')));
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('GE_PERSONAGrid_SLOGAN_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('GE_PERSONAGrid_EMAIL_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'GENERO_ID', 
                $editor, 
                $this->dataset, 'GENERO_ID', 'NOMBRE', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'CIUDAD_ID', 
                $editor, 
                $this->dataset, 'CIUDAD_ID', 'NOMBRE', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_PERSONA_modal_delete'; }
