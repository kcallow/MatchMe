...
$page_layouts["GE_PERSONA_print"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["GE_GENERO_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "GE.PERSONA" );
