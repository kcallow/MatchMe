...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("GE.BEBEDOR" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.CATEGORIA_INTERES" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.EDAD" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.FUMADOR" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.CATEGORIA_OCUPACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.CIUDAD" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.RELIGION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.SALARIO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.OCUPACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.MASCOTA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.INTERES" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.IDIOMA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.NIVEL_EDUCACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.INTERESXCATEGORIA_INTERES" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.FRECUENCIA_EJERCICIO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.GENERO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.EJERCICIO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.ESTADO_CIVIL" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.CONTEXTURA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.COLOR_PIEL" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.COLOR_PELO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.COLOR_OJOS" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.EVENTO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.TIPO_RELACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PAIS" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.OCUPACIONXCATEGORIA_OCUPACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PARAMETROS" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLE" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.WINK" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXEJERCICIO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXCOLOR_PELO" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXIDIOMA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXOCUPACION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXRELIGION" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.VISITA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXINTERES" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.PERSONA_DISPONIBLEXMASCOTA" == $this->xml_array['tables'][0])
			$isDB = true;
		if("GE.FOTO" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
}
