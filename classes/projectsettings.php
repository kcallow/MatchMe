...
function GetTableURL($table = "")
{
	...
	if("GE.BEBEDOR" == $table) 
		return "GE_BEBEDOR";
	if("GE.CATEGORIA_INTERES" == $table) 
		return "GE_CATEGORIA_INTERES";
	if("GE.EDAD" == $table) 
		return "GE_EDAD";
	if("GE.FUMADOR" == $table) 
		return "GE_FUMADOR";
	if("GE.CATEGORIA_OCUPACION" == $table) 
		return "GE_CATEGORIA_OCUPACION";
	if("GE.CIUDAD" == $table) 
		return "GE_CIUDAD";
	if("GE.RELIGION" == $table) 
		return "GE_RELIGION";
	if("GE.SALARIO" == $table) 
		return "GE_SALARIO";
	if("GE.OCUPACION" == $table) 
		return "GE_OCUPACION";
	if("GE.MASCOTA" == $table) 
		return "GE_MASCOTA";
	if("GE.INTERES" == $table) 
	...
	if("GE.IDIOMA" == $table) 
		return "GE_IDIOMA";
	if("GE.NIVEL_EDUCACION" == $table) 
		return "GE_NIVEL_EDUCACION";
	if("GE.INTERESXCATEGORIA_INTERES" == $table) 
		return "GE_INTERESXCATEGORIA_INTERES";
	if("GE.FRECUENCIA_EJERCICIO" == $table) 
		return "GE_FRECUENCIA_EJERCICIO";
	if("GE.GENERO" == $table) 
		return "GE_GENERO";
	if("GE.EJERCICIO" == $table) 
		return "GE_EJERCICIO";
	if("GE.ESTADO_CIVIL" == $table) 
		return "GE_ESTADO_CIVIL";
	if("GE.CONTEXTURA" == $table) 
		return "GE_CONTEXTURA";
	if("GE.COLOR_PIEL" == $table) 
		return "GE_COLOR_PIEL";
	if("GE.COLOR_PELO" == $table) 
		return "GE_COLOR_PELO";
	if("GE.COLOR_OJOS" == $table) 
		return "GE_COLOR_OJOS";
	if("GE.EVENTO" == $table) 
		return "GE_EVENTO";
	if("GE.TIPO_RELACION" == $table) 
		return "GE_TIPO_RELACION";
	if("GE.PAIS" == $table) 
		return "GE_PAIS";
	if("GE.OCUPACIONXCATEGORIA_OCUPACION" == $table) 
		return "GE_OCUPACIONXCATEGORIA_OCUPACION";
	if("GE.PARAMETROS" == $table) 
		return "GE_PARAMETROS";
	if("GE.PERSONA" == $table) 
		return "GE_PERSONA";
	if("GE.PERSONA_DISPONIBLE" == $table) 
		return "GE_PERSONA_DISPONIBLE";
	if("GE.WINK" == $table) 
		return "GE_WINK";
	if("GE.PERSONA_DISPONIBLEXEJERCICIO" == $table) 
		return "GE_PERSONA_DISPONIBLEXEJERCICIO";
	if("GE.PERSONA_DISPONIBLEXCOLOR_PELO" == $table) 
		return "GE_PERSONA_DISPONIBLEXCOLOR_PELO";
	if("GE.PERSONA_DISPONIBLEXIDIOMA" == $table) 
		return "GE_PERSONA_DISPONIBLEXIDIOMA";
	if("GE.PERSONA_DISPONIBLEXOCUPACION" == $table) 
		return "GE_PERSONA_DISPONIBLEXOCUPACION";
	if("GE.PERSONA_DISPONIBLEXRELIGION" == $table) 
		return "GE_PERSONA_DISPONIBLEXRELIGION";
	if("GE.VISITA" == $table) 
		return "GE_VISITA";
	if("GE.PERSONA_DISPONIBLEXINTERES" == $table) 
		return "GE_PERSONA_DISPONIBLEXINTERES";
	if("GE.PERSONA_DISPONIBLEXMASCOTA" == $table) 
		return "GE_PERSONA_DISPONIBLEXMASCOTA";
	if("GE.FOTO" == $table) 
		return "GE_FOTO";
...
{	
	...
	if(!$shortTName)
		return false;
	if("GE_BEBEDOR" == $shortTName) 
		return "GE.BEBEDOR";
	if("GE_CATEGORIA_INTERES" == $shortTName) 
		return "GE.CATEGORIA_INTERES";
	if("GE_EDAD" == $shortTName) 
		return "GE.EDAD";
	if("GE_FUMADOR" == $shortTName) 
		return "GE.FUMADOR";
	if("GE_CATEGORIA_OCUPACION" == $shortTName) 
		return "GE.CATEGORIA_OCUPACION";
	if("GE_CIUDAD" == $shortTName) 
		return "GE.CIUDAD";
	if("GE_RELIGION" == $shortTName) 
		return "GE.RELIGION";
	if("GE_SALARIO" == $shortTName) 
		return "GE.SALARIO";
	if("GE_OCUPACION" == $shortTName) 
		return "GE.OCUPACION";
	if("GE_MASCOTA" == $shortTName) 
		return "GE.MASCOTA";
	if("GE_INTERES" == $shortTName) 
		return "GE.INTERES";
	if("GE_IDIOMA" == $shortTName) 
		return "GE.IDIOMA";
	if("GE_NIVEL_EDUCACION" == $shortTName) 
		return "GE.NIVEL_EDUCACION";
	if("GE_INTERESXCATEGORIA_INTERES" == $shortTName) 
		return "GE.INTERESXCATEGORIA_INTERES";
	if("GE_FRECUENCIA_EJERCICIO" == $shortTName) 
		return "GE.FRECUENCIA_EJERCICIO";
	if("GE_GENERO" == $shortTName) 
		return "GE.GENERO";
	if("GE_EJERCICIO" == $shortTName) 
		return "GE.EJERCICIO";
	if("GE_ESTADO_CIVIL" == $shortTName) 
		return "GE.ESTADO_CIVIL";
	if("GE_CONTEXTURA" == $shortTName) 
		return "GE.CONTEXTURA";
	if("GE_COLOR_PIEL" == $shortTName) 
		return "GE.COLOR_PIEL";
	if("GE_COLOR_PELO" == $shortTName) 
		return "GE.COLOR_PELO";
	if("GE_COLOR_OJOS" == $shortTName) 
		return "GE.COLOR_OJOS";
	if("GE_EVENTO" == $shortTName) 
		return "GE.EVENTO";
	if("GE_TIPO_RELACION" == $shortTName) 
		return "GE.TIPO_RELACION";
	if("GE_PAIS" == $shortTName) 
		return "GE.PAIS";
	if("GE_OCUPACIONXCATEGORIA_OCUPACION" == $shortTName) 
		return "GE.OCUPACIONXCATEGORIA_OCUPACION";
	if("GE_PARAMETROS" == $shortTName) 
		return "GE.PARAMETROS";
	if("GE_PERSONA" == $shortTName) 
		return "GE.PERSONA";
	if("GE_PERSONA_DISPONIBLE" == $shortTName) 
		return "GE.PERSONA_DISPONIBLE";
	if("GE_WINK" == $shortTName) 
		return "GE.WINK";
	if("GE_PERSONA_DISPONIBLEXEJERCICIO" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXEJERCICIO";
	if("GE_PERSONA_DISPONIBLEXCOLOR_PELO" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXCOLOR_PELO";
	if("GE_PERSONA_DISPONIBLEXIDIOMA" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXIDIOMA";
	if("GE_PERSONA_DISPONIBLEXOCUPACION" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXOCUPACION";
	if("GE_PERSONA_DISPONIBLEXRELIGION" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXRELIGION";
	if("GE_VISITA" == $shortTName) 
		return "GE.VISITA";
	if("GE_PERSONA_DISPONIBLEXINTERES" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXINTERES";
	if("GE_PERSONA_DISPONIBLEXMASCOTA" == $shortTName) 
		return "GE.PERSONA_DISPONIBLEXMASCOTA";
	if("GE_FOTO" == $shortTName) 
		return "GE.FOTO";
}
