...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("GE.BEBEDOR" == $this->chrt_array['tables'][0])
			return true;
		if("GE.CATEGORIA_INTERES" == $this->chrt_array['tables'][0])
			return true;
		if("GE.EDAD" == $this->chrt_array['tables'][0])
			return true;
		if("GE.FUMADOR" == $this->chrt_array['tables'][0])
			return true;
		if("GE.CATEGORIA_OCUPACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.CIUDAD" == $this->chrt_array['tables'][0])
			return true;
		if("GE.RELIGION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.SALARIO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.OCUPACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.MASCOTA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.INTERES" == $this->chrt_array['tables'][0])
			return true;
		if("GE.IDIOMA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.NIVEL_EDUCACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.INTERESXCATEGORIA_INTERES" == $this->chrt_array['tables'][0])
			return true;
		if("GE.FRECUENCIA_EJERCICIO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.GENERO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.EJERCICIO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.ESTADO_CIVIL" == $this->chrt_array['tables'][0])
			return true;
		if("GE.CONTEXTURA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.COLOR_PIEL" == $this->chrt_array['tables'][0])
			return true;
		if("GE.COLOR_PELO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.COLOR_OJOS" == $this->chrt_array['tables'][0])
			return true;
		if("GE.EVENTO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.TIPO_RELACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PAIS" == $this->chrt_array['tables'][0])
			return true;
		if("GE.OCUPACIONXCATEGORIA_OCUPACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PARAMETROS" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLE" == $this->chrt_array['tables'][0])
			return true;
		if("GE.WINK" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXEJERCICIO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXCOLOR_PELO" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXIDIOMA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXOCUPACION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXRELIGION" == $this->chrt_array['tables'][0])
			return true;
		if("GE.VISITA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXINTERES" == $this->chrt_array['tables'][0])
			return true;
		if("GE.PERSONA_DISPONIBLEXMASCOTA" == $this->chrt_array['tables'][0])
			return true;
		if("GE.FOTO" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
