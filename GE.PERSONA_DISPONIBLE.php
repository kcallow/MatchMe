 ...
 */
    ...
    class GE_PERSONA_DISPONIBLEPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('TIPO_RELACION_ID', 'GE.TIPO_RELACION', new IntegerField('TIPO_RELACION_ID'), new StringField('NOMBRE', 'LA11', 'LT11'), 'LT11');
        }
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('GE_PERSONA_DISPONIBLEssearch', $this->dataset,
                array('LA1', 'ES_REAL', 'LA2', 'LA3', 'LA4', 'LA5', 'LA6', 'LA7', 'LA8', 'LA9', 'LA10', 'ALTURA', 'PESO', 'NUM_HIJOS', 'QUIERE_HIJOS', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD', 'LA11'),
                array($this->RenderText('USERNAME'), $this->RenderText('ES REAL'), $this->RenderText('COLOR OJOS ID'), $this->RenderText('COLOR PIEL ID'), $this->RenderText('CONTEXTURA ID'), $this->RenderText('NIVEL EDUCACION ID'), $this->RenderText('ESTADO CIVIL ID'), $this->RenderText('FUMADOR ID'), $this->RenderText('BEBEDOR ID'), $this->RenderText('FRECUENCIA EJERCICIO ID'), $this->RenderText('SALARIO ID'), $this->RenderText('ALTURA'), $this->RenderText('PESO'), $this->RenderText('NUM HIJOS'), $this->RenderText('QUIERE HIJOS'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD'), $this->RenderText('TIPO RELACION ID')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NOMBRE', GetOrderTypeAsSQL(otAscending));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('TIPO_RELACION_ID', $this->RenderText('TIPO RELACION ID'), $lookupDataset, 'TIPO_RELACION_ID', 'NOMBRE', false, 8));
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'TIPO_RELACION_ID', 
                $editor, 
                $this->dataset, 'TIPO_RELACION_ID', 'NOMBRE', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
    ...
    try
    {
        ...
        $Page->SetShortCaption('PERSONA DISPONIBLE');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('PERSONA DISPONIBLE');
