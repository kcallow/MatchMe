<?php
function DisplayMasterTableInfo_GE_CATEGORIA_OCUPACION($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_CATEGORIA_OCUPACION", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_CATEGORIA_OCUPACION", "masterlist"));
}
