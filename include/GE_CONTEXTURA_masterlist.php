<?php
function DisplayMasterTableInfo_GE_CONTEXTURA($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_CONTEXTURA", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_CONTEXTURA", "masterlist"));
}
