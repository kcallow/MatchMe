<?php
function DisplayMasterTableInfoForPrint_GE_OCUPACION($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_OCUPACION", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("GE_OCUPACION", "masterprint"));
}
