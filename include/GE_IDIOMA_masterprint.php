<?php
function DisplayMasterTableInfoForPrint_GE_IDIOMA($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_IDIOMA", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("GE_IDIOMA", "masterprint"));
}
