...
function checkTableName($shortTName, $type=false)
{
	...
	if ("GE_BEBEDOR" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_CATEGORIA_INTERES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_EDAD" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_FUMADOR" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_CATEGORIA_OCUPACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_CIUDAD" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_RELIGION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_SALARIO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_OCUPACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_MASCOTA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_INTERES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_IDIOMA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_NIVEL_EDUCACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_INTERESXCATEGORIA_INTERES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_FRECUENCIA_EJERCICIO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_GENERO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_EJERCICIO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_ESTADO_CIVIL" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_CONTEXTURA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_COLOR_PIEL" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_COLOR_PELO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_COLOR_OJOS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_EVENTO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_TIPO_RELACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PAIS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_OCUPACIONXCATEGORIA_OCUPACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PARAMETROS" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLE" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_WINK" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXEJERCICIO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXCOLOR_PELO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXIDIOMA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXOCUPACION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXRELIGION" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_VISITA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXINTERES" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_PERSONA_DISPONIBLEXMASCOTA" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GE_FOTO" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	$arr = array();
		$arr[]="GE.BEBEDOR";
		$arr[]="GE.CATEGORIA_INTERES";
		$arr[]="GE.EDAD";
		$arr[]="GE.FUMADOR";
		$arr[]="GE.CATEGORIA_OCUPACION";
		$arr[]="GE.CIUDAD";
		$arr[]="GE.RELIGION";
		$arr[]="GE.SALARIO";
		$arr[]="GE.OCUPACION";
		...
		$arr[]="GE.INTERES";
		$arr[]="GE.IDIOMA";
		$arr[]="GE.NIVEL_EDUCACION";
		$arr[]="GE.INTERESXCATEGORIA_INTERES";
		$arr[]="GE.FRECUENCIA_EJERCICIO";
		$arr[]="GE.GENERO";
		$arr[]="GE.EJERCICIO";
		$arr[]="GE.ESTADO_CIVIL";
		$arr[]="GE.CONTEXTURA";
		...
		$arr[]="GE.COLOR_OJOS";
		$arr[]="GE.EVENTO";
		$arr[]="GE.TIPO_RELACION";
		$arr[]="GE.PAIS";
		$arr[]="GE.OCUPACIONXCATEGORIA_OCUPACION";
		$arr[]="GE.PARAMETROS";
		$arr[]="GE.PERSONA";
		$arr[]="GE.PERSONA_DISPONIBLE";
		$arr[]="GE.WINK";
		$arr[]="GE.PERSONA_DISPONIBLEXEJERCICIO";
		$arr[]="GE.PERSONA_DISPONIBLEXCOLOR_PELO";
		$arr[]="GE.PERSONA_DISPONIBLEXIDIOMA";
		$arr[]="GE.PERSONA_DISPONIBLEXOCUPACION";
		$arr[]="GE.PERSONA_DISPONIBLEXRELIGION";
		$arr[]="GE.VISITA";
		$arr[]="GE.PERSONA_DISPONIBLEXINTERES";
		$arr[]="GE.PERSONA_DISPONIBLEXMASCOTA";
		$arr[]="GE.FOTO";
	return $arr;
}
...
function GetUserPermissions($table="")
{
	...
	if($table=="GE.CATEGORIA_OCUPACION")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.CIUDAD")
	...
	if($table=="GE.NIVEL_EDUCACION")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.INTERESXCATEGORIA_INTERES")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.FRECUENCIA_EJERCICIO")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.GENERO")
	...
	if($table=="GE.EJERCICIO")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.ESTADO_CIVIL")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.CONTEXTURA")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.COLOR_PIEL")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.COLOR_PELO")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.COLOR_OJOS")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.EVENTO")
	...
	if($table=="GE.OCUPACIONXCATEGORIA_OCUPACION")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PARAMETROS")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA")
	...
	if($table=="GE.PERSONA_DISPONIBLE")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.WINK")
	...
	if($table=="GE.PERSONA_DISPONIBLEXEJERCICIO")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA_DISPONIBLEXCOLOR_PELO")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA_DISPONIBLEXIDIOMA")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA_DISPONIBLEXOCUPACION")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA_DISPONIBLEXRELIGION")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.VISITA")
	...
	if($table=="GE.PERSONA_DISPONIBLEXINTERES")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.PERSONA_DISPONIBLEXMASCOTA")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="GE.FOTO")
