<?php
function DisplayMasterTableInfo_GE_EJERCICIO($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_EJERCICIO", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_EJERCICIO", "masterlist"));
}
