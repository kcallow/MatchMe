<?php
function DisplayMasterTableInfo_GE_COLOR_PIEL($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_COLOR_PIEL", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_COLOR_PIEL", "masterlist"));
}
