<?php
function DisplayMasterTableInfo_GE_COLOR_OJOS($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_COLOR_OJOS", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_COLOR_OJOS", "masterlist"));
}
