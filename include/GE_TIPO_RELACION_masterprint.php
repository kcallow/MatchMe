<?php
function DisplayMasterTableInfoForPrint_GE_TIPO_RELACION($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_TIPO_RELACION", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("GE_TIPO_RELACION", "masterprint"));
}
