<?php
function DisplayMasterTableInfo_GE_NIVEL_EDUCACION($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_NIVEL_EDUCACION", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("GE_NIVEL_EDUCACION", "masterlist"));
}
