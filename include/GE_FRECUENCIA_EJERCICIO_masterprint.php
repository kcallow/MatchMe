<?php
function DisplayMasterTableInfoForPrint_GE_FRECUENCIA_EJERCICIO($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_FRECUENCIA_EJERCICIO", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("GE_FRECUENCIA_EJERCICIO", "masterprint"));
}
