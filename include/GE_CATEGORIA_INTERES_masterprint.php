<?php
function DisplayMasterTableInfoForPrint_GE_CATEGORIA_INTERES($params)
{
	global $cman;
	...
	$layout = GetPageLayout("GE_CATEGORIA_INTERES", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("GE_CATEGORIA_INTERES", "masterprint"));
}
