...
if (@$_SESSION['webreports']['settings']['title'] != "") {
	...
	$xt->assign("report_title",", "."Título".": ".$title);
} else {
...
if (@$_SESSION['webreports']['tables'][0] != "") {
	...
	$xt->assign("report_table",", "."Tabla".": ".$stable);
} else {
...
if(count($_SESSION['webreports']['group_fields'])>1)
{
	...
	<tr>
		<td class="tdimg rl" style="text-align:center">
			<img src="'.GetRootPathForResources("images/layout_stepped.png").'" id="stepped" border="0" alt="'."Aspecto por pasos".'" />
			<img src="'.GetRootPathForResources("images/layout_block.png").'" id="block" border="0" alt="'."Aspecto de bloques".'" />
		</td>
	</tr>
	<tr>
		<td class="tdimg rl" style="text-align:center">
		  <img src="'.GetRootPathForResources("images/layout_align.png").'" id="align" border="0" alt="'."Aspecto alineado".'" />
		  <img src="'.GetRootPathForResources("images/layout_outline.png").'" id="outline" border="0" alt="'."Aspecto de esquema".'" />
		</td>
	</tr>';
}
else
{
	...
	<tr>
		<td class="tdimg rl" style="text-align:center">
		<img src="="'.GetRootPathForResources("images/layout_tabular.png").'" id="stepped" border="0" alt="'."Aspecto de tabla".'" />
		</td>
	</tr>
		';
