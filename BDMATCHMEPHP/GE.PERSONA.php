 ...
 */
    ...
    class GE_PERSONAPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('GE_PERSONAssearch', $this->dataset,
                array('USERNAME', 'ES_ADMIN', 'NACIMIENTO', 'PRIMER_APELLIDO', 'SEGUNDO_APELLIDO', 'NOMBRE', 'LA1', 'CIUDAD_ID', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD', 'SLOGAN'),
                array($this->RenderText('USERNAME'), $this->RenderText('ES ADMIN'), $this->RenderText('NACIMIENTO'), $this->RenderText('PRIMER APELLIDO'), $this->RenderText('SEGUNDO APELLIDO'), $this->RenderText('NOMBRE'), $this->RenderText('GENERO ID'), $this->RenderText('CIUDAD ID'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD'), $this->RenderText('SLOGAN')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('CIUDAD_ID', $this->RenderText('CIUDAD ID')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for CIUDAD_ID field
            //
            $column = new TextViewColumn('CIUDAD_ID', 'CIUDAD ID', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('ciudad_id_edit');
            $editColumn = new CustomEditColumn('CIUDAD ID', 'CIUDAD_ID', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.PERSONA');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.PERSONA');
