 ...
 */
    ...
    class GE_COLOR_PIELPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_COLOR_PIELssearch', $this->dataset,
                array('COLOR_PIEL_ID', 'NOMBRE', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('COLOR PIEL ID'), $this->RenderText('NOMBRE'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_COLOR_PIELasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('COLOR_PIEL_ID', $this->RenderText('COLOR PIEL ID')));
        ...
        {
            //
            // View column for COLOR_PIEL_ID field
            //
            $column = new TextViewColumn('COLOR_PIEL_ID', 'COLOR PIEL ID', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('color_piel_id_edit');
            $editColumn = new CustomEditColumn('COLOR PIEL ID', 'COLOR_PIEL_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_COLOR_PIEL_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_COLOR_PIELGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_COLOR_PIELPage("GE.COLOR_PIEL.php", "GE_COLOR_PIEL", GetCurrentUserGrantForDataSource("GE.COLOR_PIEL"), 'UTF-8');
        $Page->SetShortCaption('GE.COLOR PIEL');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.COLOR PIEL');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.COLOR_PIEL"));
