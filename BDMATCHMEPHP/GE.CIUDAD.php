 ...
 */
    ...
    class GE_CIUDADPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('GE_CIUDADssearch', $this->dataset,
                array('CIUDAD', 'NOMBRE', 'LA1', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('CIUDAD'), $this->RenderText('NOMBRE'), $this->RenderText('PAIS ID'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.CIUDAD');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.CIUDAD');
