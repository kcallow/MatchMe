 ...
 */
    ...
    class GE_FOTOPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_FOTOssearch', $this->dataset,
                array('FOTO_ID', 'LA1', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD', 'NOMBRE'),
                array($this->RenderText('FOTO ID'), $this->RenderText('USERNAME'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD'), $this->RenderText('NOMBRE')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_FOTOasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('FOTO_ID', $this->RenderText('FOTO ID')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateBlobSearchInput('RUTA', $this->RenderText('RUTA')));
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new FileUploadingColumn('RUTA', 'RUTA', $editor, $this->dataset, false, false, 'GE_FOTOGrid_RUTA_handler_edit');
        ...
        public function GetModalGridDeleteHandler() { return 'GE_FOTO_modal_delete'; }
        ...
        protected function CreateGrid()
        {
            ...
            GetApplication()->RegisterHTTPHandler($handler);$handler = new DownloadHTTPHandler($this->dataset, 'RUTA', 'RUTA_handler', '', '', true);
    ...
    try
    {
        $Page = new GE_FOTOPage("GE.FOTO.php", "GE_FOTO", GetCurrentUserGrantForDataSource("GE.FOTO"), 'UTF-8');
        $Page->SetShortCaption('GE.FOTO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.FOTO');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.FOTO"));
