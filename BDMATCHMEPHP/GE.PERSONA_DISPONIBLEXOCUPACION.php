 ...
 */
    ...
    class GE_PERSONA_DISPONIBLEXOCUPACIONPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_PERSONA_DISPONIBLEXOCUPACIONssearch', $this->dataset,
                array('USERNAME', 'ES_REAL', 'LA1', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('USERNAME'), $this->RenderText('ES REAL'), $this->RenderText('OCUPACION ID'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_PERSONA_DISPONIBLEXOCUPACIONasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'GE_PERSONA_DISPONIBLEXOCUPACION_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_PERSONA_DISPONIBLEXOCUPACIONGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_PERSONA_DISPONIBLEXOCUPACIONPage("GE.PERSONA_DISPONIBLEXOCUPACION.php", "GE_PERSONA_DISPONIBLEXOCUPACION", GetCurrentUserGrantForDataSource("GE.PERSONA_DISPONIBLEXOCUPACION"), 'UTF-8');
        $Page->SetShortCaption('GE.PERSONA DISPONIBLEXOCUPACION');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.PERSONA DISPONIBLEXOCUPACION');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.PERSONA_DISPONIBLEXOCUPACION"));
