 ...
 */
    ...
    class GE_ESTADO_CIVILPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_ESTADO_CIVILssearch', $this->dataset,
                array('ESTADO_CIVIL_ID', 'NOMBRE', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('ESTADO CIVIL ID'), $this->RenderText('NOMBRE'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_ESTADO_CIVILasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ESTADO_CIVIL_ID', $this->RenderText('ESTADO CIVIL ID')));
        ...
        {
            //
            // View column for ESTADO_CIVIL_ID field
            //
            $column = new TextViewColumn('ESTADO_CIVIL_ID', 'ESTADO CIVIL ID', $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_ESTADO_CIVIL_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_ESTADO_CIVILGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.ESTADO CIVIL');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.ESTADO CIVIL');
