 ...
 */
    ...
    class GE_COLOR_PELOPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_COLOR_PELOssearch', $this->dataset,
                array('COLOR_PELO_ID', 'NOMBRE', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('COLOR PELO ID'), $this->RenderText('NOMBRE'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_COLOR_PELOasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('COLOR_PELO_ID', $this->RenderText('COLOR PELO ID')));
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('color_pelo_id_edit');
            $editColumn = new CustomEditColumn('COLOR PELO ID', 'COLOR_PELO_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_COLOR_PELO_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_COLOR_PELOGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.COLOR PELO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.COLOR PELO');
