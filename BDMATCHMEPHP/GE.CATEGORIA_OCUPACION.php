 ...
 */
    ...
    class GE_CATEGORIA_OCUPACIONPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_CATEGORIA_OCUPACIONssearch', $this->dataset,
                array('CATEGORIA_OCUPACION_ID', 'NOMBRE', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('CATEGORIA OCUPACION ID'), $this->RenderText('NOMBRE'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_CATEGORIA_OCUPACIONasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('CATEGORIA_OCUPACION_ID', $this->RenderText('CATEGORIA OCUPACION ID')));
        ...
        {
            //
            // View column for CATEGORIA_OCUPACION_ID field
            //
            $column = new TextViewColumn('CATEGORIA_OCUPACION_ID', 'CATEGORIA OCUPACION ID', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('categoria_ocupacion_id_edit');
            $editColumn = new CustomEditColumn('CATEGORIA OCUPACION ID', 'CATEGORIA_OCUPACION_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_CATEGORIA_OCUPACION_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_CATEGORIA_OCUPACIONGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_CATEGORIA_OCUPACIONPage("GE.CATEGORIA_OCUPACION.php", "GE_CATEGORIA_OCUPACION", GetCurrentUserGrantForDataSource("GE.CATEGORIA_OCUPACION"), 'UTF-8');
        $Page->SetShortCaption('GE.CATEGORIA OCUPACION');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.CATEGORIA OCUPACION');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.CATEGORIA_OCUPACION"));
