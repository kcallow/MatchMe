 ...
 */
    ...
    class GE_PERSONA_DISPONIBLEXEJERCICIOPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, true);
            $this->dataset->AddLookupField('EJERCICIO_ID', 'GE.EJERCICIO', new IntegerField('EJERCICIO_ID'), new StringField('NOMBRE', 'LA1', 'LT1'), 'LT1');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_PERSONA_DISPONIBLEXEJERCICIOssearch', $this->dataset,
                array('USERNAME', 'ES_REAL', 'LA1', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('USERNAME'), $this->RenderText('ES REAL'), $this->RenderText('EJERCICIO ID'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_PERSONA_DISPONIBLEXEJERCICIOasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('EJERCICIO_ID', $this->RenderText('EJERCICIO ID'), $lookupDataset, 'EJERCICIO_ID', 'NOMBRE', false, 8));
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'EJERCICIO_ID', 
                $editor, 
                $this->dataset, 'EJERCICIO_ID', 'NOMBRE', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_PERSONA_DISPONIBLEXEJERCICIO_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_PERSONA_DISPONIBLEXEJERCICIOGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.PERSONA DISPONIBLEXEJERCICIO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.PERSONA DISPONIBLEXEJERCICIO');
