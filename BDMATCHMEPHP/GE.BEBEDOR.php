 ...
 */
    ...
    class GE_BEBEDORPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_BEBEDORssearch', $this->dataset,
                array('BEBEDOR_ID', 'TIPO', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('BEBEDOR ID'), $this->RenderText('TIPO'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_BEBEDORasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('BEBEDOR_ID', $this->RenderText('BEBEDOR ID')));
        ...
        {
            //
            // View column for BEBEDOR_ID field
            //
            $column = new TextViewColumn('BEBEDOR_ID', 'BEBEDOR ID', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('bebedor_id_edit');
            $editColumn = new CustomEditColumn('BEBEDOR ID', 'BEBEDOR_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_BEBEDOR_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_BEBEDORGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_BEBEDORPage("GE.BEBEDOR.php", "GE_BEBEDOR", GetCurrentUserGrantForDataSource("GE.BEBEDOR"), 'UTF-8');
        $Page->SetShortCaption('GE.BEBEDOR');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.BEBEDOR');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.BEBEDOR"));
