 ...
 */
    ...
    class GE_EVENTOPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('GE_EVENTOssearch', $this->dataset,
                array('EVENTO_ID', 'NOMBRE', 'FECHA', 'LUGAR', 'DESCRIPCION', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('EVENTO ID'), $this->RenderText('NOMBRE'), $this->RenderText('FECHA'), $this->RenderText('LUGAR'), $this->RenderText('DESCRIPCION'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('FECHA', $this->RenderText('FECHA'), 'Y-m-d'));
    ...
    try
    {
        ...
        $Page->SetShortCaption('GE.EVENTO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.EVENTO');
