 ...
 */
    ...
    class GE_EJERCICIOPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_EJERCICIOssearch', $this->dataset,
                array('EJERCICIO_ID', 'NOMBRE', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('EJERCICIO ID'), $this->RenderText('NOMBRE'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_EJERCICIOasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('EJERCICIO_ID', $this->RenderText('EJERCICIO ID')));
        ...
        {
            //
            // View column for EJERCICIO_ID field
            //
            $column = new TextViewColumn('EJERCICIO_ID', 'EJERCICIO ID', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('ejercicio_id_edit');
            $editColumn = new CustomEditColumn('EJERCICIO ID', 'EJERCICIO_ID', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_EJERCICIO_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_EJERCICIOGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_EJERCICIOPage("GE.EJERCICIO.php", "GE_EJERCICIO", GetCurrentUserGrantForDataSource("GE.EJERCICIO"), 'UTF-8');
        $Page->SetShortCaption('GE.EJERCICIO');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('GE.EJERCICIO');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.EJERCICIO"));
