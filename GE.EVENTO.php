 ...
 */
    ...
    class GE_EVENTOPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_EVENTOssearch', $this->dataset,
                array('EVENTO_ID', 'NOMBRE', 'FECHA_HORA', 'LUGAR', 'DESCRIPCION', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD', 'LA1'),
                array($this->RenderText('EVENTO ID'), $this->RenderText('NOMBRE'), $this->RenderText('FECHA HORA'), $this->RenderText('LUGAR'), $this->RenderText('DESCRIPCION'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD'), $this->RenderText('CIUDAD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_EVENTOasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('EVENTO_ID', $this->RenderText('EVENTO ID')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('FECHA_HORA', $this->RenderText('FECHA HORA'), 'Y-m-d'));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('CIUDAD', $this->RenderText('CIUDAD'), $lookupDataset, 'CIUDAD_ID', 'NOMBRE', false, 8));
        }
        ...
        public function GetModalGridDeleteHandler() { return 'GE_EVENTO_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_EVENTOGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('DESCRIPCION', 'DESCRIPCION', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'GE_EVENTOGrid_DESCRIPCION_handler_list', $column);
