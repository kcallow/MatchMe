...
$layout = new TLayout("edit2", "Rounded1DeliciousLavender1", "MobileDeliciousLavender1");
$layout->version = 2;
...
$page_layouts["GE_OCUPACIONXCATEGORIA_OCUPACION_edit"] = $layout;
...
$keys = array();
$keys["OCUPACION_ID"] = postvalue("editid1");
$keys["CATEGORIA_OCUPACION_ID"] = postvalue("editid2");
