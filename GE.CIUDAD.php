 ...
 */
    ...
    class GE_CIUDADPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('PAIS_ID', 'GE.PAIS', new IntegerField('PAIS_ID'), new StringField('NOMBRE', 'LA1', 'LT1'), 'LT1');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('GE_CIUDADssearch', $this->dataset,
                array('CIUDAD_ID', 'NOMBRE', 'LA1', 'FEC_CREACION', 'USUARIO_CREACION', 'FEC_ULTIMA_MOD', 'USUARIO_ULTIMA_MOD'),
                array($this->RenderText('CIUDAD ID'), $this->RenderText('NOMBRE'), $this->RenderText('PAIS ID'), $this->RenderText('FEC CREACION'), $this->RenderText('USUARIO CREACION'), $this->RenderText('FEC ULTIMA MOD'), $this->RenderText('USUARIO ULTIMA MOD')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('GE_CIUDADasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('PAIS_ID', $this->RenderText('PAIS ID'), $lookupDataset, 'PAIS_ID', 'NOMBRE', false, 8));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            // View column for NOMBRE field
            //
            $column = new TextViewColumn('LA1', 'PAIS ID', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('pais_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new OracleConnectionFactory(),
                GetConnectionOptions(),
                '"GE"."PAIS"');
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'PAIS_ID', 
                $editor, 
                $this->dataset, 'PAIS_ID', 'NOMBRE', $lookupDataset);
        ...
        public function GetModalGridDeleteHandler() { return 'GE_CIUDAD_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'GE_CIUDADGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new GE_CIUDADPage("GE.CIUDAD.php", "GE_CIUDAD", GetCurrentUserGrantForDataSource("GE.CIUDAD"), 'UTF-8');
        $Page->SetShortCaption('CIUDAD');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('CIUDAD');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("GE.CIUDAD"));
