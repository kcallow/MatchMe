CREATE OR REPLACE PROCEDURE PERSONAS_POR_COLOR_PELO(pCOLOR_PELO IN COLOR_PELO.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE COLOR_PELO.NOMBRE = pCOLOR_PELO;
END PERSONAS_POR_COLOR_PELO;
