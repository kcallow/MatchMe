CREATE OR REPLACE PROCEDURE PERSONAS_POR_RELIGION(pRELIGION IN RELIGION.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE RELIGION.NOMBRE = pRELIGION;
END PERSONAS_POR_RELIGION;
