CREATE OR REPLACE PROCEDURE PERSONAS_POR_EMAIL(pEMAIL IN PERSONA.EMAIL%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA.EMAIL = pEMAIL;
END PERSONAS_POR_EMAIL;
