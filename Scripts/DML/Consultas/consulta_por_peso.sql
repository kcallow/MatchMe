CREATE OR REPLACE PROCEDURE PERSONAS_POR_PESO(pPESO IN PERSONA_DISPONIBLE.PESO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.PESO = pPESO;
END PERSONAS_POR_PESO;
