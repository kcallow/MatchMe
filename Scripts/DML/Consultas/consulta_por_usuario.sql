CREATE OR REPLACE PROCEDURE PERSONAS_POR_USUARIO(pUSUARIO_ID IN PERSONA_DISPONIBLE.USERNAME%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.USERNAME = pUsuario_ID;
END PERSONAS_POR_USUARIO;
