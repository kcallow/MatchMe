CREATE OR REPLACE PROCEDURE PERSONAS_POR_COLOR_PIEL(pCOLOR_PIEL IN COLOR_PIEL.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE COLOR_PIEL.NOMBRE = pCOLOR_PIEL;
END PERSONAS_POR_COLOR_PIEL;
