CREATE OR REPLACE PROCEDURE PERSONAS_POR_CANTIDAD_HIJOS(pCANT_HIJOS IN PERSONA_DISPONIBLE.NUM_HIJOS%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.NUM_HIJOS = pCANT_HIJOS;
END PERSONAS_POR_CANTIDAD_HIJOS;
