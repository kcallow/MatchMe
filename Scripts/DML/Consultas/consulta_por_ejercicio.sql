CREATE OR REPLACE PROCEDURE PERSONAS_POR_EJERCICIO(pEJERCICIO IN EJERCICIO.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE EJERCICIO.NOMBRE = pEJERCICIO;
END PERSONAS_POR_EJERCICIO;
