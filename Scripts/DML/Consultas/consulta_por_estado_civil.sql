CREATE OR REPLACE PROCEDURE PERSONAS_POR_ESTADO_CIVIL(pESTADO_CIVIL IN ESTADO_CIVIL.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE ESTADO_CIVIL.NOMBRE = pESTADO_CIVIL;
END PERSONAS_POR_ESTADO_CIVIL;
