CREATE OR REPLACE PROCEDURE PERSONAS_POR_OCUPACION(pOCUPACION IN OCUPACION.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE OCUPACION.NOMBRE = pOCUPACION;
END PERSONAS_POR_OCUPACION;
