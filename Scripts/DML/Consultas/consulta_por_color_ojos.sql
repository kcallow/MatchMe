CREATE OR REPLACE PROCEDURE PERSONAS_POR_COLOR_OJOS(pCOLOR_OJOS IN COLOR_OJOS.NOMBRE%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE COLOR_OJOS.NOMBRE = pCOLOR_OJOS;
END PERSONAS_POR_COLOR_OJOS;
