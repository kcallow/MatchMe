CREATE OR REPLACE PROCEDURE PERSONAS_POR_EDUCACION(pEDUCACION IN NIVEL_EDUCACION.GRADO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE NIVEL_EDUCACION.GRADO = pEDUCACION;
END PERSONAS_POR_EDUCACION;
