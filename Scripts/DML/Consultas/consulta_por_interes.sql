CREATE OR REPLACE PROCEDURE PERSONAS_POR_INTERES(pINTERES IN iNTERES.Nombre%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE INTERES.NOMBRE= pINTERES;
END PERSONAS_POR_INTERES;
