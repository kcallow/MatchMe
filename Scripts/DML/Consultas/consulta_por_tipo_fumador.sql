CREATE OR REPLACE PROCEDURE PERSONAS_POR_TIPO_FUMADOR(pFUMADOR IN FUMADOR.TIPO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE FUMADOR.TIPO = pFUMADOR;
END PERSONAS_POR_TIPO_FUMADOR;
