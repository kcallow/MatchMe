CREATE OR REPLACE PROCEDURE PERSONAS_POR_QUIERE_MASCOTA(pQMASCOTAS IN MASCOTA.TIPO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.quiere_mascotas = pQMASCOTAS;
END PERSONAS_POR_QUIERE_MASCOTA;
