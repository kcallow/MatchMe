CREATE OR REPLACE PROCEDURE PERSONAS_POR_CONTEXTURA(pCONTEXTURA IN CONTEXTURA.TIPO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE CONTEXTURA.TIPO = pCONTEXTURA;
END PERSONAS_POR_CONTEXTURA;
