CREATE OR REPLACE PROCEDURE PERSONAS_POR_FREQ_EJERCICIO(pFREQ_EJER IN FRECUENCIA_EJERCICIO.RANGO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE FRECUENCIA_EJERCICIO.RANGO = pFREQ_EJER;
END PERSONAS_POR_FREQ_EJERCICIO;
