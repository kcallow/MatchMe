CREATE OR REPLACE PROCEDURE PERSONAS_POR_PRIMER_APELLIDO(pPRIMER_APELLIDO IN PERSONA.PRIMER_APELLIDO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA.PRIMER_APELLIDO = pPRIMER_APELLIDO;
END PERSONAS_POR_PRIMER_APELLIDO;
