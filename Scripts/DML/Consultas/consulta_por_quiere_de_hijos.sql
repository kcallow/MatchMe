CREATE OR REPLACE PROCEDURE PERSONAS_POR_QUIERE_HIJOS(pQUIERE_HIJOS IN PERSONA_DISPONIBLE.QUIERE_HIJOS%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.QUIERE_HIJOS = pQUIERE_HIJOS;
END PERSONAS_POR_QUIERE_HIJOS;
