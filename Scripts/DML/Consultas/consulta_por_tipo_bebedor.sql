CREATE OR REPLACE PROCEDURE PERSONAS_POR_BEBEDOR(pBEBEDOR IN BEBEDOR.TIPO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE BEBEDOR.TIPO = pBEBEDOR;
END PERSONAS_POR_BEBEDOR;
