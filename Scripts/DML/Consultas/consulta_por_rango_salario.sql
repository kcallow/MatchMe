CREATE OR REPLACE PROCEDURE PERSONAS_POR_RANGO_SALARIO(pRANGO_SALARIO IN SALARIO.RANGO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE SALARIO.RANGO = pRANGO_SALARIO;
END PERSONAS_POR_RANGO_SALARIO;
