CREATE OR REPLACE PROCEDURE PERSONAS_POR_ALTURA(pALTURA IN PERSONA_DISPONIBLE.ALTURA%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA_DISPONIBLE.ALTURA = pALTURA;
END PERSONAS_POR_ALTURA;
