CREATE OR REPLACE PROCEDURE PERSONAS_POR_SEGUNDO_APELLIDO(pSEGUNDO_APELLIDO IN PERSONA.SEGUNDO_APELLIDO%TYPE, P_RECORDSET OUT SYS_REFCURSOR)
AS
BEGIN
...
WHERE PERSONA.SEGUNDO_APELLIDO = pSEGUNDO_APELLIDO;
END PERSONAS_POR_SEGUNDO_APELLIDO;
